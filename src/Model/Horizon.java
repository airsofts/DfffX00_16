...
public class Horizon extends Region {
    ...
    public Horizon() {
        ...
        earthColor       = new SimpleObjectProperty<>(this, "earthColor", Color.CHOCOLATE);
    ...
    private void initGraphics() {
        ...
        horizonCanvas = new Canvas(PREFERRED_WIDTH+200, PREFERRED_HEIGHT+200);
        ...
        pane.setStyle("-fx-border-color:lime");

        getChildren().setAll(pane);
        resize();
        Rectangle r2=new Rectangle(260, 260);
        r2.setArcHeight(70);
        r2.setArcWidth(70);
        pane.setClip(r2); 
